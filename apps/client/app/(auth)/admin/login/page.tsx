        ...
        <div className="max-w-md my-auto">
          ...
          <div className="relative rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-md shadow-2xl">
            <div className="flex items-center justify-between border-b border-white/10 pb-3.5 mb-3.5">
              ...
              <span className="text-[9px] font-bold tracking-wider text-secondary/50 uppercase font-mono">Overview Statistics</span>
            </div>

            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-lg bg-white/5 p-3 border border-white/5">
                <span className="text-[10px] text-secondary/60 block font-medium">Active Reviewers</span>
                <span className="text-xl font-bold text-white mt-1 block">42</span>
              </div>
              <div className="rounded-lg bg-white/5 p-3 border border-white/5">
                <span className="text-[10px] text-secondary/60 block font-medium">Total Bookings</span>
                <span className="text-xl font-bold text-white mt-1 block">189</span>
              </div>
            </div>
          </div>
        </div>
