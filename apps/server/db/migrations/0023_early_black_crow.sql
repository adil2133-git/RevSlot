ALTER TABLE "event_types" ADD COLUMN IF NOT EXISTS "feedback_form_id" integer;--> statement-breakpoint
ALTER TABLE "event_types" DROP CONSTRAINT IF EXISTS "event_types_feedback_form_id_feedback_forms_id_fk";--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_event_types_feedback_form" ON "event_types" USING btree ("feedback_form_id");--> statement-breakpoint
