ALTER TABLE "event_types" DROP CONSTRAINT IF EXISTS "event_types_feedback_form_id_feedback_forms_id_fk";
--> statement-breakpoint
ALTER TABLE "feedback_form_fields" DROP CONSTRAINT IF EXISTS "feedback_form_fields_form_id_feedback_forms_id_fk";
--> statement-breakpoint
DROP INDEX IF EXISTS "idx_event_types_feedback_form";--> statement-breakpoint
...
ALTER TABLE "event_types" DROP COLUMN IF EXISTS "feedback_form_id";