DO $$ BEGIN
    CREATE TYPE "public"."feedback_field_type" AS ENUM('text', 'textarea', 'number', 'select');
EXCEPTION
...
--> statement-breakpoint
ALTER TABLE "feedback" DROP CONSTRAINT IF EXISTS "feedback_booking_id_bookings_id_fk";--> statement-breakpoint
...
ALTER TABLE "feedback" DROP CONSTRAINT IF EXISTS "feedback_reviewer_id_reviewers_id_fk";--> statement-breakpoint
...
ALTER TABLE "feedback" DROP CONSTRAINT IF EXISTS "feedback_form_id_feedback_forms_id_fk";--> statement-breakpoint
...
ALTER TABLE "feedback_forms" DROP CONSTRAINT IF EXISTS "feedback_forms_reviewer_id_reviewers_id_fk";--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_feedback_booking" ON "feedback" USING btree ("booking_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_feedback_form_fields_form" ON "feedback_form_fields" USING btree ("form_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_feedback_forms_reviewer" ON "feedback_forms" USING btree ("reviewer_id");